...
export const Contact = () => {
    ...
    // Leaves all other details and updates only entered detail
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();     // page doesn't get reloaded when user submit form
                            ...
                            <form onSubmit={handleSubmit}>
                                <Row>
                                    ...
                                    </Col>
                                    {
                                        status.message &&
                                        <Col>
                                            <p className={status.success === false ? "failure" : "success"}>{status.message}</p>
                                        </Col>
                                    }
                                </Row>
                            </form>
